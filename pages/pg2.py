...
dash.register_page(__name__,
                   path='/tasa-de-empleo',  # represents the url text
                   name='Tasa de Empleo',  # name of page, commonly used as name of link
                   title='Tasa de Empleo'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/empleo.csv")
...
df = df.query(f"indicador == 'Tasa de empleo'")
