...
dash.register_page(__name__,
                   path='/horas-de-trabajo',  # represents the url text
                   name='Horas semanales en trabajo remunerado',  # name of page, commonly used as name of link
                   title='Horas semanales en trabajo remunerado'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/horas_trabajadas.csv")
...
df = df.query(f"indicador == 'Horas de trabajo'")
