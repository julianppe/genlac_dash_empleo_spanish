...
dash.register_page(__name__,
                   path='/asalariados',  # represents the url text
                   name='Asalariados/as',  # name of page, commonly used as name of link
                   title='Asalariados/as'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/asalariados.csv")
...
df = df.query(f"indicador == 'Asalariados/as'")
