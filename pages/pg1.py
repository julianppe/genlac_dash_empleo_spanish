...
dash.register_page(__name__,
                   ...
                   name='Tasa de participación laboral',  # name of page, commonly used as name of link
                   title='Tasa de participación laboral',  # title that appears on browser's tab
...
df = pd.read_csv("datasets/participacion.csv")
