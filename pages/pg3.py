...
dash.register_page(__name__,
                   path='/tasa-de-desempleo',  # represents the url text
                   name='Tasa de Desempleo',  # name of page, commonly used as name of link
                   title='Tasa de Desempleo'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/desempleo.csv")
...
df = df.query(f"indicador == 'Tasa de desempleo'")
